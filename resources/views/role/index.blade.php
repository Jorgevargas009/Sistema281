...
<div class="container-fluid px-4">
    ...
    <div class="mb-4"><a href="{{route('roles.create')}}"><button type="button" class="btn-primary">Añadir nuevo rol</button></a>
    </div>
    <div class="card mb-4">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{route('roles.destroy',['role' =>$item])}}" method="post">
                                        @method('DELETE')
                                        @csrf
